...
export const SUPPORTED_LANGUAGES: Record<SupportedLanguageCode, LanguageInfo> = {
  ...
  cy: {
    ...
    regions: ["Wales"],
    greeting: "Shwmae",
    translationNotes: "Smaller training corpus. Translations may need advisor review for formal documents.",
    speakersMillions: 0.7,
  },
  bn: {
    code: "bn",
    name: "Bengali",
  ...
  pa: {
    ...
    flag: "IN",
    direction: "ltr",
    scriptHint: "Use Gurmukhi script.",
    iso639_2: "pan",
    iso639_3: "pan",
    script: "Gurmukhi",
    family: ["Indo-European", "Indo-Aryan"],
  ...
  ps: {
    ...
    iso639_3: "pus",
    script: "Arabic",
    family: ["Indo-European", "Iranian", "Eastern Iranian"],
    regions: ["Afghanistan", "Pakistan"],
    greeting: "سلام",
    translationNotes: "Lower-resource language pair. Translations may need advisor review.",
    speakersMillions: 40,
  },
  so: {
    code: "so",
  ...
  ti: {
    ...
    iso639_3: "tir",
    script: "Ge'ez",
    family: ["Afro-Asiatic", "Semitic", "South Semitic"],
  ...
  ar: {
    ...
    regions: ["Saudi Arabia", "Egypt", "Iraq", "Morocco", "UAE"],
    greeting: "مرحبا",
    translationNotes: "OPUS-MT targets Modern Standard Arabic. Dialectal text may produce less accurate results.",
  ...
  fr: {
    ...
    regions: ["France", "Belgium", "Canada", "Switzerland"],
    greeting: "Bonjour",
    speakersMillions: 80,
  },
  es: {
    ...
    script: "Latin",
    family: ["Indo-European", "Romance"],
    regions: ["Spain", "Mexico", "Colombia", "Argentina"],
    greeting: "Hola",
    speakersMillions: 475,
  },
  it: {
    code: "it",
    name: "Italian",
