...
export const MODEL_REGISTRY: Record<LanguagePairId, ModelInfo> = {
  ...
  "en-pt": {
    modelId: "opus-mt-en-ROMANCE",
    sourceLang: "en",
    targetLang: "pt",
    availableDtypes: ["fp32", "fp16", "int8", "q4"],
    recommendedDtype: "q4",
    approximateSizeBytes: 120 * 1024 * 1024,
    licence: "CC-BY-4.0",
    attribution: "OPUS-MT, Helsinki-NLP. Trained on OPUS data.",
  },
  "en-pl": {
    ...
    availableDtypes: ["fp32", "fp16", "int8", "q4"],
    recommendedDtype: "q4",
    approximateSizeBytes: 145 * 1024 * 1024,
    licence: "CC-BY-4.0",
    attribution: "OPUS-MT, Helsinki-NLP. Trained on OPUS data.",
  },
  "en-ar": {
...
export function isRTL(code: LanguageCode): boolean {
  return isSupportedLanguage(code) ? SUPPORTED_LANGUAGES[code].direction === "rtl" : false;
}
...
export function getDirection(code: LanguageCode): ScriptDirection {
  return isSupportedLanguage(code) ? SUPPORTED_LANGUAGES[code].direction : "ltr";
}
